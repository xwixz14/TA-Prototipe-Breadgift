...
export default function AdminSidebar({ isOpen, onClose }: AdminSidebarProps) {
  ...
  return (
    <>
      ...
      <aside className={`fixed inset-y-0 left-0 w-64 h-full bg-white border-r border-zinc-100 flex flex-col justify-between py-6 z-[120] transition-transform duration-300 lg:relative lg:translate-x-0 ${isOpen ? "translate-x-0 shadow-2xl" : "-translate-x-full"
        }`}>
